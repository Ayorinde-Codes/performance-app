...
<body style="background-color:lightgrey;" data-new-gr-c-s-check-loaded="14.996.0" data-gr-ext-installed="">
  ...
  <div style="background-color:lightgrey;">
    ...
    <div style="margin:0px auto;max-width:600px;">
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td style="width:550px;">
                                        <img alt="welcome image" height="auto" src="{{ asset('images/handman2.png') }}" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:14px;" width="550" />
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                            ...
                            <tr>
                              <td align="right" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Quattrocento;font-size:14px;font-weight:400;line-height:24px;text-align:right;color:#000000;"> </div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Quattrocento;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#000000;">
                                  <h5 style="margin: 0; font-size: 32px; line-height: 40px; font-weight: 700;">Welcome to Apin </h5>
                                </div>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Quattrocento;font-size:16px;font-weight:400;line-height:24px;text-align:center;color:#333333;">Have questions or need help? Email us at <a href="#" style="color: #428dfc; text-decoration: none; font-weight: bold;"> hello@apin.com </a></div>
                              </td>
                            </tr>
                          </tbody></table>
                        </div>
          ...
          <![endif]-->
                        <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            ...
                            <tr>
                              <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Quattrocento;font-size:16px;font-weight:400;line-height:24px;text-align:center;color:#333333;">Lagos adddress here<br /> © 2020 [apin] Inc.</div>
                              </td>
                            </tr>
                            <tr>
                              <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
      ...
      <![endif]-->
                            ...
                            <tr>
                              <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Quattrocento;font-size:16px;font-weight:400;line-height:24px;text-align:center;color:#333333;">Update your email preferences  to choose the types of emails you receive from all future emails.</div>
                              </td>
                            </tr>
                          </tbody></table>
                        </div>
